...
{
	float theta1 = DEG_TO_RAD * angleposition.Theta1;//i1_1
	float theta2 = DEG_TO_RAD * angleposition.Theta2;//i2_1
	float theta3 = DEG_TO_RAD * angleposition.Theta3;//i3_1

	float t = (Data.RD_F - Data.RD_E);
